    ...
    <header className="sticky top-0 bg-white shadow">
      <div className="container flex flex-col sm:flex-row justify-between items-center mx-auto py-4 px-8">
        ...
        <div className="hidden md:block">
            <button
                    type="button" onClick={handleNavigation2}
        ...
        <div className="container mx-auto px-8 lg:flex">
          <div className="text-center lg:text-left lg:w-1/2">
            ...
            <p className="text-xl lg:text-2xl mt-6 font-light">
              Modèle de page de destination gratuit pour promouvoir le démarrage
              de votre entreprise et générer des prospects pour les
              services proposés
            </p>
        ...
        <div className="container mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row sm:-mx-3 mt-12">
            <div className="flex-1 px-3">
              ...
              >
                <p className="font-semibold text-xl">Gestion des Projets</p>
                <p className="mt-4">
                Simplifiez l'organisation de vos projets en suivant les étapes et les objectifs
                 avec une vue claire et structurée.
                </p>
              </div>
            </div>
            <div className="flex-1 px-3">
              <div
                ...
                style={{ boxShadow: "0 10px 28px rgba(0,0,0,.08)" }}
              >
                <p className="font-semibold text-xl">Suivi des Tâches</p>
                <p className="mt-4">
                  Gardez un œil sur vos tâches assignées, terminez-les à temps et améliorez 
            ...
            <div className="flex-1 px-3">
              <div
                ...
                style={{ boxShadow: "0 10px 28px rgba(0,0,0,.08)" }}
              >
                <p className="font-semibold text-xl">Collaboration en Équipe</p>
                <p className="mt-4">
                Travaillez efficacement avec votre équipe grâce à des fonctionnalités de 
                communication .
                </p>
              </div>
            </div>
